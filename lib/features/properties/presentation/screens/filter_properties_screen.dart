...
class FilterPropertiesScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('property Status', style: getStyle20(context)),
